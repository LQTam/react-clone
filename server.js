...
// db config
const mongoURI=process.env.MONGO_URL|| "mongodb+srv://admin:U2g5tosCowT9bd54@cluster0.nlyri.mongodb.net/facebookdb?retryWrites=true&w=majority"
...
app.post('/upload/image',upload.single('file'),(req,res)=>{res.status(201).send(req.file)})
